...
class ResultsLoadStateAdapter(private val retry: () -> Unit) : LoadStateAdapter<ResultsLoadStateViewHolder>() {

    override fun onBindViewHolder(holder: ResultsLoadStateViewHolder, loadState: LoadState) {
        holder.bind(loadState)
    }

    override fun onCreateViewHolder(parent: ViewGroup, loadState: LoadState): ResultsLoadStateViewHolder {
